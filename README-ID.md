...
- **Pencarian & Pagination**: Cari kampanye berdasarkan ID atau Judul, dan navigasikan halaman dengan sistem *pagination* yang rapi.
...
Isi dana pada *testnet address* dan lakukan deploy:
```bash
