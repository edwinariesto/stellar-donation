...
export default function App() {
  ...
  const showOnboardingGuide = () => {
    Swal.fire({
      ...
      iconHtml: '<div class="w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center border-4 border-white shadow-sm"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#007AFF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg></div>',
          ...
          <div className="bg-white rounded-3xl p-6 shadow-ios border border-ios-lightGray/30 mt-8 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-blue-50 rounded-full blur-3xl -mr-10 -mt-10 opacity-60"></div>
              ...
              <div className="flex items-center gap-3 mb-2 relative z-10">
                <div className="w-10 h-10 flex-shrink-0 rounded-full bg-red-100 flex items-center justify-center text-red-500 shadow-sm border border-red-200">
                ...
                {currentOwnerTransfers.length > 0 ? (
                  currentOwnerTransfers.map((tx, idx) => {
                    ...
                    <div key={idx} className="flex items-center justify-between p-4 rounded-2xl border border-gray-100 bg-white hover:border-blue-100 hover:shadow-sm transition-all group">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 flex-shrink-0 rounded-full bg-red-50 text-red-500 flex items-center justify-center border border-red-100 group-hover:bg-red-500 group-hover:text-white transition-colors">
            ...
            <div className="bg-gradient-to-b from-slate-900 to-black w-full max-w-md rounded-3xl shadow-2xl relative overflow-hidden border border-emerald-900/50 z-10 flex flex-col p-6 animate-ios-fade-in glow-emerald">
              ...
              <div className="flex-1 bg-slate-900/80 rounded-2xl p-4 border border-slate-800 flex flex-col overflow-hidden relative shadow-inner">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <input
                    type="text"
                    placeholder={t.searchEvent || 'Cari acara...'}
                    value={vipSearch}
                  ...
                  {currentVipHistory.length > 0 ? (
                    ...
                    <div className="h-full flex flex-col items-center justify-center opacity-50">
                      ...
                      <p className="text-xs text-slate-400 font-mono text-center max-w-[200px]">
                        {t.vipEmptyHistory || 'Catatan seluruh kehadiran eksklusif Anda di acara StelDot.'}
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="flex justify-center items-center gap-2 mt-3 pt-3 border-t border-slate-700/50">
                  <button onClick={() => setVipPage(p => Math.max(1, p - 1))} disabled={vipPage === 1} className="p-1 rounded-full text-slate-500 hover:text-emerald-400 disabled:opacity-30 transition-colors">
                  ...
                  <button onClick={() => setVipPage(p => Math.min(totalVipPages, p + 1))} disabled={vipPage === totalVipPages || totalVipPages === 0} className="p-1 rounded-full text-slate-500 hover:text-emerald-400 disabled:opacity-30 transition-colors">
