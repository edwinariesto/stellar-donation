        ...
        {userAddress && (
          <section className="bg-white rounded-2xl p-6 shadow-ios border border-ios-lightGray/30 mb-8 flex flex-col md:flex-row items-center justify-between gap-6 glow-blue">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-full bg-blue-50 border border-blue-100 flex items-center justify-center font-bold text-xl text-ios-blue">
                🏆
              </div>
              <div>
        ...
        {isOwner && (
          <section className="bg-white border-2 border-ios-red/20 rounded-2xl p-8 shadow-ios mb-12 bg-gradient-to-br from-red-50/10 to-white">
            ...
            <div className="flex items-center gap-3 border-b border-ios-lightGray pb-4 mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FF3B30" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-ios-red flex-shrink-0">
                <rect x="3" y="11" width="18" height="11" rx="2" ry="2"/>
                <path d="M7 11V7a5 5 0 0 1 10 0v4"/>
              </svg>
              <div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <h2 className="text-xl font-bold tracking-tight text-ios-darkText flex items-center gap-2">
                📂 {t.activeCampaigns}
              </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-ios border border-ios-lightGray/30">
              <h2 className="text-lg font-bold tracking-tight text-ios-darkText mb-4 flex items-center gap-2">
                🏆 {t.topContributors}
              </h2>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-ios border border-ios-lightGray/30 text-xs text-ios-secondaryText space-y-3">
              ...
              <div className="flex flex-col gap-2 font-semibold">
                <a href="mailto:support@steldot.org" className="text-ios-blue hover:underline flex items-center gap-1.5">
                  ✉️ support@steldot.org
                </a>
                <a href="https://github.com/stellar-steldot" target="_blank" rel="noopener noreferrer" className="text-ios-blue hover:underline flex items-center gap-1.5">
