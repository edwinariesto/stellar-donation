export const translations = {
  id: {
    ...
    simulateDiscount: 'Simulasikan Diskon',
    simulateDesc: 'Masukkan alamat dompet dan nominal untuk mensimulasikan potongan 2%. Maksimal 5 kali penggunaan per dompet.',
    targetAddress: 'Alamat Target',
    originalAmount: 'Nominal Asli (XLM)',
    calculateDiscount: 'Hitung Potongan 2%',
  ...
  en: {
    ...
    simulateDiscount: 'Simulate Discount',
    simulateDesc: 'Enter target wallet address and amount to simulate a 2% discount. Maximum 5 uses per wallet.',
    targetAddress: 'Target Address',
    originalAmount: 'Original Amount (XLM)',
    calculateDiscount: 'Calculate 2% Discount',
