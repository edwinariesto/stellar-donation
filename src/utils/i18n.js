export const translations = {
  id: {
    ...
    wcSessionExpired: 'Sesi WalletConnect Anda telah berakhir atau terputus. Silakan klik tombol "Disconnect", lalu hubungkan ulang dompet Anda.',
    ...
    requestFailedDesc: 'Gagal mengirimkan klaim hadiah.',
    invalidCode: 'Kode Tidak Valid',
    invalidCodeDesc: 'Shopping Voucher Code tidak valid atau sudah kedaluwarsa.',
    close: 'Tutup',
    cancel: 'Batal',
    ...
    vipPassDesc: 'Tunjukkan Barcode Eksklusif ini pada seluruh acara resmi StelDot di seluruh dunia untuk mendapatkan akses Free VIP dan penggantian biaya transportasi penuh. Verifikasi tiket hanya dapat dilakukan oleh wallet Pemilik Utama StelDot.',
    ...
    simulateDiscount: 'Eksekusi Diskon',
    simulateDesc: 'Masukkan alamat dompet dan nominal untuk mengeksekusi potongan 2%. Maksimal 5 kali penggunaan per dompet.',
    targetAddress: 'Wallet Pembeli Voucher',
    originalAmount: 'Nominal Asli (XLM)',
    calculateDiscount: 'Eksekusi Diskon',
    discountHistoryTitle: 'Riwayat Penggunaan Diskon',
    remainingUses: 'Sisa Penggunaan',
    usageLimitReached: 'Batas penggunaan 5 kali telah tercapai untuk dompet ini.',
    discountApplied: 'Diskon berhasil diterapkan!',
    noDiscountHistory: 'Belum ada riwayat penggunaan diskon.',
    totalPay: 'Total Bayar',
    discountAmount: 'Potongan (2%)',
    totalUsers: 'Pengguna Terhubung',
    totalUsersDesc: 'Dompet unik di jaringan StelDot',
    angelTitle: 'Tautan Referral Malaikat',
    angelDesc: 'Bagikan tautan unik Anda. Anda akan mendapatkan 0.5% dari donasi pertama setiap teman yang menggunakan tautan ini!',
    ...
    claimDetailTitle: 'Detail Transaksi',
    friendDonor: 'Teman (Donor)',
    donationAmount: 'Jumlah Donasi (XLM)',
    success: 'Sukses',
    closeBtn: 'Tutup',
    ...
    vipEmptyHistory: 'Rekam jejak seluruh kehadiran eksklusif Anda di event StelDot.',
    ...
    partnerTitle: 'Mitra Pengundang',
    partnerDesc: 'Anda diundang oleh malaikat kebaikan. Donasi pertama Anda akan memberikan bonus untuk mereka.',
    helpingAngelTitle: 'Malaikat Penolong (Referral)',
    helpingAngelDesc: (balance) => `Anda memiliki saldo reward referral sebesar <strong>${balance} XLM</strong>.`,
    claimReferralBtn: 'Klaim Reward Referral',
    referralHistoryTitle: 'Daftar Teman Berdonasi',
    noReferralHistory: 'Belum ada teman yang berdonasi menggunakan link Anda.',
    shareLinkTitle: 'Bagikan Link Referral',
    shareLinkDesc: 'Ajak teman berdonasi dan dapatkan 0.5% dari donasi pertama mereka.',
    ...
    clientWallet: 'Wallet Penerima (Client)',
    clientWalletEg: 'G...',
    expirationDate: 'Tanggal Berakhir',
    transferredToClient: 'Dana Ditransfer ke Client',
    transferHistory: 'Riwayat Transfer',
    transferToClient: 'Transfer Dana ke Client',
    ...
    insufficientBalance: 'Saldo XLM di dompet Anda tidak mencukupi untuk transaksi ini. Silakan top up saldo Freighter Anda dan coba lagi.',
    ...
    eventName: 'Nama Acara/Event',
    vipHistoryTitle: 'Riwayat Kehadiran VIP',
    vipAttendanceDesc: 'Catatan seluruh kehadiran eksklusif Anda di acara StelDot.',
    simulateVipEntry: 'Proses Kehadiran VIP',
    scanVoucherTab: 'Scan Voucher',
    scanEventTab: 'Scan Event',
    vipPresent: 'HADIR',
    vipOnlyOwner: '*Pemindaian dan verifikasi tiket VIP ini hanya dapat dilakukan secara eksklusif oleh Pemilik Utama StelDot.',
    vipAccessDenied: 'Akses Ditolak',
    vipAccessDeniedDesc: 'Pemindaian tiket VIP Legend hanya dapat dilakukan oleh wallet Pemilik Utama StelDot.',
    scanWalletTitle: 'Scan Dompet Target',
    vipValidationSuccess: 'Kehadiran Tercatat!',
    vipValidationSuccessDesc: 'Kehadiran VIP berhasil diverifikasi dan disimpan ke riwayat.',
    participantWallet: 'Wallet Peserta Event',
    participantWalletLabel: 'Wallet Peserta VIP',
    vipScanInstruction: 'Pindai atau masukkan alamat wallet peserta untuk memverifikasi kehadiran VIP. Peserta wajib memiliki akumulasi donasi minimal 500 XLM.',
    vipScannedBy: 'Discan oleh (Owner StelDot)',
    totalDonated: 'Total Donasi',
    legendValid: 'Legend Valid',
    legendNotValid: 'Belum Legend',
    verifying: 'Memverifikasi...',
    validationFailed: 'Validasi Gagal',
    validationFailedDesc: 'Total donasi wallet peserta ini hanya {amount} XLM. Akses VIP Legend membutuhkan minimal 500 XLM.',
    scanVoucherTab: 'Scan Voucher',
    scanEventTab: 'Scan Event',
  ...
  en: {
    ...
    wcSessionExpired: 'Your WalletConnect session has expired or disconnected. Please click the "Disconnect" button, then reconnect your wallet.',
    ...
    requestFailedDesc: 'Failed to submit reward claim.',
    invalidCode: 'Invalid Code',
    invalidCodeDesc: 'The Shopping Voucher Code is invalid or has expired.',
    close: 'Close',
    cancel: 'Cancel',
    ...
    vipPassTitle: 'VIP Legend Pass',
    vipPassDesc: 'Show this Exclusive Barcode at any official StelDot events worldwide to get Free VIP access. Ticket verification can only be performed by the main StelDot Owner wallet.',
    vipWalletAddress: 'VIP Wallet Address',
    ambassadorPassTitle: 'Ambassador Voucher',
    ...
    simulateDiscount: 'Execute Discount',
    simulateDesc: 'Enter target wallet address and amount to execute a 2% discount. Maximum 5 uses per wallet.',
    targetAddress: 'Voucher Buyer Wallet',
    originalAmount: 'Original Amount (XLM)',
    calculateDiscount: 'Execute Discount',
    discountHistoryTitle: 'Discount Usage History',
    remainingUses: 'Remaining Uses',
    usageLimitReached: 'The 5-use limit has been reached for this wallet.',
    discountApplied: 'Discount applied successfully!',
    noDiscountHistory: 'No discount usage history yet.',
    totalPay: 'Total Pay',
    discountAmount: 'Discount (2%)',
    totalUsers: 'Connected Users',
    totalUsersDesc: 'Unique wallets on StelDot network',
    angelTitle: 'Angel Referral Link',
    angelDesc: 'Share your unique link. You will earn 0.5% of the first donation made by every friend who connects and donates through this link!',
    copyLink: 'Copy Link',
    ...
    claimDetailTitle: 'Transaction Detail',
    friendDonor: 'Friend (Donor)',
    donationAmount: 'Donation Amount (XLM)',
    success: 'Success',
    closeBtn: 'Close',
    transactionHash: 'Transaction Hash',
    searchHash: 'Search Wallet...',
    searchWallet: 'Search Wallet...',
    searchEvent: 'Search event...',
    vipEmptyHistory: 'Record of all your exclusive attendances at StelDot events.',
    ...
    partnerTitle: 'Inviting Partner',
    partnerDesc: 'You were invited by a helping angel. Your first donation will reward them.',
    helpingAngelTitle: 'Helping Angel (Referral)',
    helpingAngelDesc: (balance) => `You have a referral reward balance of <strong>${balance} XLM</strong>.`,
    claimReferralBtn: 'Claim Referral Reward',
    referralHistoryTitle: 'Donated Friends List',
    noReferralHistory: 'No friends have donated using your link yet.',
    shareLinkTitle: 'Share Referral Link',
    shareLinkDesc: 'Invite friends to donate and earn 0.5% of their first donation.',
    copyLink: 'Copy Link',
    ...
    clientWallet: 'Client Wallet (Receiver)',
    clientWalletEg: 'G...',
    expirationDate: 'Expiration Date',
    transferredToClient: 'Funds Transferred to Client',
    transferHistory: 'Transfer History',
    transferToClient: 'Transfer Funds to Client',
    ...
    insufficientBalance: 'Your XLM wallet balance is insufficient for this transaction. Please top up your Freighter wallet and try again.',
    ...
    vipHistoryTitle: 'VIP Attendance History',
    vipAttendanceDesc: 'Record of all your exclusive attendances at StelDot events.',
    simulateVipEntry: 'Process VIP Entry',
    scanVoucherTab: 'Scan Voucher',
    scanEventTab: 'Scan Event',
    vipPresent: 'PRESENT',
    vipOnlyOwner: '*Scanning and verification of this VIP ticket can only be performed exclusively by the StelDot Owner.',
    vipAccessDenied: 'Access Denied',
    vipAccessDeniedDesc: 'Scanning VIP Legend tickets can only be performed by the StelDot Owner wallet.',
    scanWalletTitle: 'Scan Target Wallet',
    vipValidationSuccess: 'Attendance Recorded!',
    vipValidationSuccessDesc: 'VIP attendance successfully verified and saved to history.',
    participantWallet: 'Event Participant Wallet',
    participantWalletLabel: 'VIP Participant Wallet',
    vipScanInstruction: 'Scan or enter the participant\'s wallet address to verify VIP attendance. Participants must have a cumulative donation of at least 500 XLM.',
    vipScannedBy: 'Scanned by (StelDot Owner)',
    totalDonated: 'Total Donated',
    legendValid: 'Legend Valid',
    legendNotValid: 'Not a Legend',
    verifying: 'Verifying...',
    validationFailed: 'Validation Failed',
    validationFailedDesc: 'This participant\'s total donation is only {amount} XLM. VIP Legend access requires a minimum of 500 XLM.',
    scanVoucherTab: 'Scan Voucher',
    scanEventTab: 'Scan Event',
